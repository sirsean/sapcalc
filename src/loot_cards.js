...
export const LOOT_CARDS = [
  ...
  new LootCard(7, 'Rare Skull', 543),
  new LootCard(8, 'Linno Beetle', 543),
  new LootCard(9, 'Ommonite', 3),
  new LootCard(10, 'Augurbox', 543),
  ...
  new LootCard(20, 'Murk Ring', 7),
  new LootCard(21, 'SUIT COAG', 6),
  new LootCard(22, 'Blackfish', 5),
  new LootCard(23, 'Wirecutters', 4),
];